...
public static void main(String[] args) {
    ...
    System.out.println("==============================================");
        ...
        for (int i = 0; i < elemen; i++) {
            System.out.println("Factorial of value  " +fk[1].num+" is : " +fk[i].faktorialBF(fk[i].num));
        }
        System.out.println("==============================================");
        System.out.println("Factorial Result with DIVIDE and CONQUER");
        for (int i = 0; i < elemen; i++) {
            System.out.println("Factorial of value  " +fk[1].num+" is : "  + fk[i].faktorialDC(fk[i].num));
        }
        System.out.println("==============================================");
